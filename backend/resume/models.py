...
class Job(models.Model):
    ...
    description = RichTextField(help_text="Short summary shown on the card (Index View)")
    more_details = RichTextField(blank=True, null=True, help_text="Full details shown when card is clicked")
